...
// agregar jQuery objeto diferido
    this.jqDeferred = new $.Deferred();
  }

  // HACK marca asincrónico para permitir tiempo para enlazar oyentes
...
ImagesLoaded.prototype.getImages = function() {
  ...
  // filtro y encontrar elementos si tenemos un selector de elementos
...
// obtener imagen de fondo en el elemento
...
// encuentra niños
  // no hay nodos sin elementos, # 143
...
// concat childElems para filtrar la matriz encontrada
...
// obtener imágenes de fondo de niños
...
// Firefox devuelve null si está en un iframe oculto https://bugzil.la/548397
    return;
  }
  // get url inside url("...")
  var reURL = /url\((['"])?(.*?)\1\)/gi;
...
ImagesLoaded.prototype.check = function() {
 ...
 // completo si no hay imágenes
  ...
  function onProgress( image, elem, message ) {
    // HACK - Chrome activa el evento antes de que las propiedades del objeto hayan cambiado. # 83
...
// Si se completa y el navegador admite tamaños naturales,
  // intento verificar el estado de la imagen manualmente
  var isComplete = this.getIsImageComplete();
  if ( isComplete ) {
    // informe basado en naturalWidth
    this.confirm( this.img.naturalWidth !== 0, 'naturalWidth' );
    return;
  }

  // Si ninguno de los controles anteriores coincide, simule la carga en el elemento separado.

  this.proxyImage = new Image();
  this.proxyImage.addEventListener( 'load', this );
  this.proxyImage.addEventListener( 'error', this );
  
// enlace a la imagen también para Firefox. # 191
...
// activa el controlador especificado para el tipo de evento
...
// hereda el prototipo de carga de imágenes
...
// verifica si la imagen ya está completa
  var isComplete = this.getIsImageComplete();
  if ( isComplete ) {
    this.confirm( this.img.naturalWidth !== 0, 'naturalWidth' );
    this.unbindEvents();
